...
//            'account_number' => ['required', 'string', 'max:255'],
    ...
    public function show(Abonent $abonent)
    {
        ...
        $tarifs = Tarif::where('organization_id', $abonent->organization_id)
        ...
        return view('abonent.show',
            compact('abonent', 'saldos', 'accruals', 'payments', 'counters', 'notices', 'accrual_types', 'tarifs'));
    }
...
//            'account_number' => ['required', 'string', 'max:255'],
        ...
        $abonent->fill($request->only('location_number', 'square', 'user_id'));
        $abonent->street = $request->street;
        $abonent->save();
