...
@section('content')
    <div class="container">
        <form action="{{route('abonents.update', $abonent)}}" method="post">
            ...
            {{--                   value="{{ $abonent->account_number }}" required autocomplete="account_number" autofocus>--}}
            ...
            <div class="form-floating mb-3">
                <input type="text" id="location_number" name="location_number"
                       ...
                       value="{{ $abonent->location_number }}" required autocomplete="location_number">
            ...
            <div class="form-floating mb-3">
                <input type="text" id="street" name="street"
                       ...
                       value="{{ $abonent->street }}" autocomplete="street">
            ...
            <div class="form-floating mb-3">
                <input type="number" id="square" name="square" step="0.01"
                       class="form-control @error('square') is-invalid @enderror" value="{{ $abonent->square }}"
            ...
            <div>
                <div class="form-check">
                    <input class="form-check-input" type="checkbox" id="ownership" name="ownership"
                           onchange="changeOwnership(this.checked)" {{($abonent->ownership == true) ? "checked" : ""}}>
                    <label class="form-check-label ps-1">{{__('Ownership')}}</label>
                </div>
            </div>
            <div id="cadastral_number_div" class="form-floating mb-3"
                 style="display: {{($abonent->ownership == true) ? "block" : "none"}}">
                <input type="text" id="cadastral_number" name="cadastral_number"
                       class="form-control @error('cadastral_number') is-invalid @enderror"
                       value="{{ $abonent->cadastral_number }}" autocomplete="cadastral_number">
            ...
            <div>
                ...
                <select name="user_id" id="user_id"
                    ...
                    @foreach($users as $user)
                        <option value="{{$user->id}}" {{$user->id == $abonent->user_id? 'selected' : ''}}>
            ...
            <div class="col-md-6 offset-md-4">
                <input type="hidden" name="organization_id" value="{{$abonent->organization_id}}">
